...
urlpatterns = [
    ...
    path("administrateur/selectionner", views.selectionner_transit, name = 'selectionner_transit'),
    ...
    path("administrateur/en_ramassage", views.en_livraison_admin_view, name = 'en_ramassage_admin'),
